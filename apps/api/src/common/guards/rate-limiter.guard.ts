...
export class RateLimiterGuard implements CanActivate {
  ...
  constructor(
    ...
    this.maxRequests = parseInt(this.configService.get<string>('RATE_LIMIT_MAX') || '100', 10);
    this.windowSeconds = parseInt(this.configService.get<string>('RATE_LIMIT_WINDOW') || '60', 10);
  }
